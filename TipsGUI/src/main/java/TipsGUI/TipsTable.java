...
import javax.swing.text.*;
    ...
    /**
     * TipsTable is based on RXTable, which is a class developed by tips4java on GitHub.
     * Source: <a href="https://github.com/tips4java/tips4java/blob/main/source/RXTable.java">...</a>
     *
     * The RXTable class provides some extensions to the default JTable
     *
     ...
     */
    public class TipsTable extends JTable
    {
        ...
        //
        /**
         * Constructs a default <code>TipsTable</code> that is initialized with a default
        ...
        /**
         * Constructs a <code>TipsTable</code> that is initialized with
         * <code>dm</code> as the data model, a default column model,
         * and a default selection model.
         *
         * @param dm        the data model for the table
         */
        public TipsTable(TableModel dm)
        {
            this(dm, null, null);
        }
         ...
         */
        public TipsTable(TableModel dm, TableColumnModel cm)
        {
            this(dm, cm, null);
        }
         ...
         */
        public TipsTable(TableModel dm, TableColumnModel cm, ListSelectionModel sm)
        {
            super(dm, cm, sm);
        }

        /**
         * Constructs a <code>TipsTable</code> with <code>numRows</code>
         ...
         */
        public TipsTable(int numRows, int numColumns)
        {
            this(new DefaultTableModel(numRows, numColumns));
        }

        /**
         * Constructs a <code>TipsTable</code> to display the values in the
         ...
         */
        public TipsTable(Vector rowData, Vector columnNames)
        {
            this(new DefaultTableModel(rowData, columnNames));
        }

        /**
         * Constructs a <code>TipsTable</code> to display the values in the two-dimensional array,
         ...
         * @param columnNames       names of each column
         */
        public TipsTable(final Object[][] rowData, final Object[] columnNames)
        {
